...
<body>
	...
	<table>
		...
		%>
		<tr
			onclick="location.href='./detail.jsp?bno=<%=list.get(i).getBno()%>'">
			<td><%=list.get(i).getBno()%></td>
			<td id="title">
			
			<!-- 
			 /*String title = "";
			if(list.get(i).getBtitle().length() > 12){
				title = list.get(i).getBtitle().substring(0, 11);
				title += "...";
			} else {
